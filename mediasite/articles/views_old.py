...
from article.models import Post,PostForm,Category, Comment,CommentForm,Author,AuthorForm
...
def main(request):
    ...
    return render_to_response('article/list.html', RequestContext(request, {'posts':posts,'categories':categories}))
    #return render_to_response("article/list.html", dict(posts,posts,categories=categories, user=request.user))
...
def article_detail(request,article_id):
    ...
    try:
        ...
        posts = paginator.page(paginator.num_pages)
    return render_to_response("article/detail.html", RequestContext(request, {'posts':posts,'categories':categories,'comments':comments}))
...
def comment_post(request,article_id):
    ...
    try:
        ...
        posts = paginator.page(paginator.num_pages)
    return render_to_response("article/detail.html", RequestContext(request, {'posts':posts,'categories':categories}))
...
def authors(request):
    ...
    return render_to_response('article/author_edit.html',
                              {'author_form': form,
...
def fileView(request):
    ...
    try:
        ...
        posts = paginator.page(paginator.num_pages)
    return render_to_response("article/myarticle.html", RequestContext(request, {'posts':posts}))
...
def uploadView(request):
    ...
    return render_to_response('article/writearticle.html',
                              {'post_form': form,
                               'author_id': request.session['author_id']},
                              context_instance=RequestContext(request))
...
def author_add(request):
        ...
        return render_to_response('article/author_add.html',
                                  {'author_form': form},
                                  context_instance=RequestContext(request))
...
def login(request):
    ...
    if request.method != 'POST':
        return render_to_response('article/login.html', RequestContext(request, {}))
    try:
        ...
        return render_to_response('article/login.html', RequestContext(request, {'messages':msg}))
